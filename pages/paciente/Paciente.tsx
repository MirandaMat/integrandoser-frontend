...
const PacienteDashboard = () => {
    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            setLoading(true);
            try {
                const response = await fetch('http://localhost:3001/api/users/my-dashboard/patient', {
                 ...
                 <div className="dashboard-widget widget-welcome">
                    ...
                    {dashboardData.nextAppointment ? (
                        <div className="next-appointment-details">
                            <img src={dashboardData.nextAppointment.professional_photo ? `http://localhost:3001/${dashboardData.nextAppointment.professional_photo}` : '/assets/default-avatar.png'} alt="Foto do profissional" />
