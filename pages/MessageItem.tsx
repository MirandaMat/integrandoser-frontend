                                    ...
                                    <div key={att.id} className="attachment-item">
                                        {att.file_type.startsWith('image/') ? (
                                            <a href={`http://localhost:3001/${att.file_url}`} target="_blank" rel="noopener noreferrer">
                                                <img src={`http://localhost:3001/${att.file_url}`} alt="Anexo" className="attachment-image" />
                                            </a>
                                        ) : (
                                            <a href={`http://localhost:3001/${att.file_url}`} target="_blank" rel="noopener noreferrer" className="attachment-file">
                                                <FiFileText />
