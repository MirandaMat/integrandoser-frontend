            ...
            <ul className="widget-list-cards">
                {posts.map(post => (
                    <li key={post.id} className="widget-card-item">
                        <img
                            src={post.image_url ? `http://localhost:3001/${post.image_url}` : '/assets/default-blog.png'}
                            alt={post.title}
        ...
        <div className="professionals-grid">
            {professionals && professionals.map(prof => (
                <div key={prof.id} className="professional-card" onClick={() => onProfessionalClick(prof.user_id)}>
                    <img
                        src={prof.imagem_url ? `http://localhost:3001/${prof.imagem_url}` : '/assets/default-avatar.png'}
                        alt={prof.nome}
    ...
    return (
        <>
            ...
            <div className="admin-dashboard-grid-v2">
                ...
                <RecentBlogsWidget posts={dashboardData.siteContent.latestBlogs || []} />
