...
const TptEditor = ({ initialData, onSaveSuccess, onSaveError }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await axios.put('http://localhost:3001/api/content/tpt', dataToSave, {
            ...
            <fieldset>
                ...
                <div className="form-group">
                    ...
                    <div className="image-preview-container">
                        <img src={imagePreview || (formData.about_image_url ? `http://localhost:3001/${formData.about_image_url}`: '/assets/default-placeholder.png')} alt="Preview" className="image-preview" />
