...
const ScheduleAppointmentPage = () => {
    ...
    useEffect(() => {
        const fetchAvailability = async () => {
            try {
                const response = await axios.get('http://localhost:3001/api/scheduling/availability/public');
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post('http://localhost:3001/api/scheduling/appointments/public', {
