...
const Service = () => {
    ...
    useEffect(() => {
        const fetchServiceData = async () => {
            ...
            try {
                ...
                const response = await axios.get(`${apiUrl}/api/content/services/${serviceSlug}`);
    ...
    return (
        <main className="service-page-container">
            <section className="service-hero" style={{ backgroundImage: `url(${apiUrl}/${service.image_url})` }}>
