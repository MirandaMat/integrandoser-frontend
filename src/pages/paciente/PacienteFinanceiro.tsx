    ...
    const fetchData = async () => {
        ...
        try {
            const [invoicesRes, transactionsRes, sessionsRes] = await Promise.all([
                ...
                fetch(`${apiUrl}/api/finance/my-transactions`, { headers: { 'Authorization': `Bearer ${token}` } }),
                fetch(`${apiUrl}/api/finance/my-sessions/patient`, { headers: { 'Authorization': `Bearer ${token}` } })
            ]);
