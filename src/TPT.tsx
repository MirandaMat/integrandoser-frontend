...
const TPT = () => {
    ...
    useEffect(() => {
        ...
        const fetchTptContent = async () => {
            try {
                const response = await axios.get(`${apiUrl}/api/content/tpt`);
                ...
                <div className="tpt-about-container">
                    ...
                    <div className="tpt-about-grid">
                        ...
                        <div className="tpt-about-image">
                            <Reveal><img src={content.about_image_url ? `${apiUrl}/${content.about_image_url}` : "/tpt_acolhimento.png"} alt="Acolhimento Terapêutico" /></Reveal>
                        </div>
                    </div>
                </div>
            </section>
